...
export function FavoritesBar({ count, favoritesOnly, onToggle }: Props) {
  return (
    <button
      className={`fixed bottom-5 right-5 z-40 flex items-center gap-3 rounded-full px-7 py-4 text-lg font-600 shadow-xl transition-all duration-200 hover:scale-105 active:scale-95 ${
        favoritesOnly
